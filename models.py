...
from utils import sent2features, tensorized, sort_by_lengths, cal_lstm_crf_loss
...
class BiLSTM(nn.Module):
    ...
    def forward(self, sents_tensor, lengths):
        ...
        scores = self.lin(lstm_out)  # [B, L, out_size]
...
class BiLSTM_CRF(nn.Module):
    ...
    def forward(self, sents_tensor, lengths):
        # [B, L, out_size]
        emission = self.bilstm(sents_tensor, lengths) # 发射矩阵
